package com.quick.eats.order.service.domain.mapper;

import com.quick.eats.domain.valueobject.CustomerId;
import com.quick.eats.domain.valueobject.Money;
import com.quick.eats.domain.valueobject.ProductId;
import com.quick.eats.domain.valueobject.RestaurantId;
...
import com.quick.eats.order.service.domain.valueobject.StreetAddress;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(
            List<com.quick.eats.order.service.domain.dto.create.OrderItem> orderItems) {
